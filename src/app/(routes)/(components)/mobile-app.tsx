        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          >
            ...
            <p className='text-xl text-muted-foreground mb-8'>
              Experience the full power of our platform on the go. Download our
              iOS app for a seamless mobile experience.
            </p>
            <Button size='lg' className='gap-2'>
              <Download className='h-5 w-5' />
              <Link
                href='https://apps.apple.com/us/app/pickpockt/id6736374764'
                target='_blank'
              >
                Download on iOS
              </Link>
            ...
            <Button size='lg' variant='outline' className='ml-4 gap-2'>
              ...
              <Link
                href='https://testflight.apple.com/join/YpgPyVs5'
                target='_blank'
              >
                Test Flight Beta
              </Link>
